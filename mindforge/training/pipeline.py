...
End-to-end training pipeline for MindForge consciousness and KVRM grounding.
...
class TrainingPipeline:
    """
    End-to-end training pipeline for MindForge.
    ...
    def train(
        ...
        if adapter_name is None:
            ...
            adapter_name = f"mindforge_adapter_{timestamp}"
...
def create_training_pipeline(
    ...
    """
    from mindforge.config import get_config
