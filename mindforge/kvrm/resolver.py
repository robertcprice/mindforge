...
class MemoryKeyStore(KeyStore):
    ...
    def __init__(self, memory_store: Any):
        """
        Initialize with a MindForge MemoryStore.

        Args:
            memory_store: Instance of mindforge.memory.store.MemoryStore
        """
        super().__init__("MindForge Memory", KeyType.MEMORY, read_only=False)
