...
from mindforge_dna.ego import EgoModel, EgoConfig, TimingDecision, PERSONALITY_PROMPT
...
def test_teacher_role():
    ...
    for i, example_spec in enumerate(examples, 1):
        ...
        print(f"  Input: {example.get('input', 'N/A')[:200]}...")
...
def test_corrector_role():
    ...
    for i, failure in enumerate(failures, 1):
        ...
        print(f"  Learning Pattern: {correction.get('learning_pattern', 'N/A')[:150]}...")
...
def run_all_tests():
    ...
    print("\n" + "="*80)
    print("MINDFORGE DNA - EGO MODEL TEST SUITE")
    print("="*80)
