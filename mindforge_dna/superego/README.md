...
The Superego layer provides **immutable ethical and safety constraints** for MindForge DNA. These systems cannot be modified at runtime and enforce core values, operational safety, and knowledge verification.
...
Database:
~/.mindforge/kvrm_facts.db  # SQLite database for facts/memories
```
...
Part of MindForge DNA - see project LICENSE.
...
- Consult main MindForge DNA documentation
