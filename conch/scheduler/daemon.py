...
The always-on background service that keeps Conch thinking.
Coordinates:
- Trigger monitoring
- Task scheduling
- File watching
...
from conch.scheduler.tasks import TaskScheduler, TaskPriority
from conch.scheduler.triggers import TriggerManager, Trigger, TriggerType, create_default_triggers
...
class ConchDaemon:
    """The always-on daemon service for Conch.
    ...
    def start(self, blocking: bool = True) -> None:
        ...
        logger.info("=" * 60)
        logger.info("CONCH DAEMON STARTING")
        logger.info("=" * 60)
    ...
    def stop(self) -> None:
        ...
        logger.info("=" * 60)
        logger.info("CONCH DAEMON STOPPED")
...
def run() -> None:
    ...
    logger.info("Starting Conch daemon...")
