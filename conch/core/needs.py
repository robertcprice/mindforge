"""
Conch Needs-Regulator System

A dynamic priority system that guides decision-making based on competing needs.
Unlike survival-focused systems, Conch's needs serve the ultimate goal of
...
class NeedType(Enum):
    """Types of needs in the Conch system.
...
class NeedsRegulator:
    """Manages the dynamic needs system for Conch.
