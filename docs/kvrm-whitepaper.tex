...
\definecolor{mindforgeblue}{RGB}{41,128,185}
...
\lhead{MindForge Technical Report}
\rfoot{Page \thepage}
...
\title{
    ...
    \vspace{0.5cm}
    \large{MindForge Technical Report v1.0}
}

\author{
    MindForge Project \\
    \texttt{github.com/conscious/mindforge}
}
...
We integrate KVRM into \textbf{MindForge}, demonstrating that grounded consciousness is practically achievable without sacrificing the flexibility required for autonomous operation.
...
\begin{tikzpicture}[
    ...
    % Nodes
    \node[box, fill=mindforgeblue!20] (thought) {Thought\\Generator};
    ...
    \node[box, fill=mindforgeblue!20, right=of router] (decision) {Decision\\Engine};
...
% ============================================================
\section{Integration with MindForge Consciousness}
% ============================================================

\subsection{The Consciousness Cycle}

MindForge implements a consciousness cycle:
...
\end{tikzpicture}
\caption{MindForge Consciousness Cycle with KVRM Grounding}
\label{fig:cycle}
\end{figure}
...
\begin{enumerate}
    ...
    \item \textbf{Seamless integration} with the MindForge consciousness cycle
\end{enumerate}
...
The complete implementation is available as part of the MindForge project.
