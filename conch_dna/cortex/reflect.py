"""
Conch DNA - Cortex Layer: ReflectCortex

The reflection neuron analyzes action outcomes and maintains a journal.
Uses Qwen3-1.7B with r=8 for efficient reflection.
...
{"reflection": "2-3 sentences", "outcome_assessment": "success|partial|failure", "lessons_learned": ["lesson1"], "mood": "satisfied|curious|concerned|frustrated|confident|uncertain|motivated|neutral", "confidence_in_understanding": 0.0-1.0, "suggested_next_steps": ["step1"] or null}

Example:
{"reflection": "The deployment failed due to a missing env var.", "outcome_assessment": "partial", "lessons_learned": ["Validate env vars"], "mood": "concerned", "confidence_in_understanding": 0.7, "suggested_next_steps": ["Add preflight check"]}"""
    ...
    def __init__(
        ...
        self._expected_fields = ["reflection", "outcome_assessment", "mood"]
...
Respond with JSON only. Begin your response with {{"""
    ...
    def _parse_output(self, raw_output: str) -> Dict[str, Any]:
        ...
        try:
            ...
            reflect_data = json.loads(json_text)
            ...
            reflect_data.setdefault("reflection", raw_output)
            reflect_data.setdefault("lessons_learned", [])
            reflect_data.setdefault("confidence_in_understanding", 0.5)
            ...
            return {
                ...
                "lessons_learned": ["Failed to parse reflection structure"],
