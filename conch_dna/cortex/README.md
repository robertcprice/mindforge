...
├─────────────────────────────────────────────────────┤
│                                                      │
│  ThinkCortex       → Qwen3-4B-4bit (reasoning, r=16) │
│  TaskCortex        → Qwen3-1.7B-4bit (tasks, r=8)    │
│  ActionCortex      → Qwen3-1.7B-4bit (tools, r=8)    │
│  ReflectCortex     → Qwen3-1.7B-4bit (reflection, r=8)│
│  DebugCortex       → Qwen3-1.7B-4bit (debug, r=16)   │
│  MemoryCortex      → Qwen3-1.7B-4bit (memory, r=16)  │
│                                                      │
└─────────────────────────────────────────────────────┘
...
```python
from conch_dna.cortex import ThinkCortex, TaskCortex, ActionCortex
...
```python
from conch_dna.cortex import create_cortex_suite
...
```python
from conch_dna.cortex import ThinkCortex
...
```python
from conch_dna.cortex import TaskCortex
...
```python
from conch_dna.cortex import ActionCortex
...
```python
from conch_dna.cortex import ReflectCortex
...
```python
from conch_dna.cortex import DebugCortex
...
```python
from conch_dna.cortex import MemoryCortex
...
```python
from conch_dna.cortex import NeuronConfig, NeuronDomain
...
config = NeuronConfig(
    ...
    lora_rank=16,
    confidence_threshold=0.7,
    max_tokens=None,  # uncapped; streaming stops naturally
    temperature=0.7,
...
### Model Sizes
- **Qwen3-1.7B-4bit**: efficient action/task/reflect/debug/memory neurons (LoRA r=8-16)
- **Qwen3-4B-4bit**: reasoning-heavy ThinkCortex (LoRA r=16)
...
```bash
# Run example usage
python conch_dna/cortex/example_usage.py

# Syntax check
python3 -m py_compile conch_dna/cortex/*.py
```
...
6. **Deploy**: Use in Conch consciousness loop
