"""
Conch DNA - Cortex Layer: MemoryCortex

The Memory neuron handles memory retrieval, importance scoring, and compression.
Uses Qwen3-1.7B with r=16 and CLaRa compression for efficient memory management.
...
{"importance": 0.0-1.0, "is_sacred": true/false, "summary": "brief text", "key_concepts": ["concept1"], "emotional_weight": 0.0-1.0, "temporal_relevance": 0.0-1.0}

Sacred (importance >= 0.75): learning moments, emotional events, human interactions
Routine (importance < 0.75): standard operations, repeated patterns

Example:
{"importance": 0.8, "is_sacred": true, "summary": "Learned new debugging technique", "key_concepts": ["debugging", "learning"], "emotional_weight": 0.6, "temporal_relevance": 0.9}"""
    ...
    def __init__(
        ...
        self._expected_fields = ["importance", "is_sacred", "summary"]
    ...
    def _prepare_prompt(self, input_data: Dict[str, Any]) -> str:
        ...
        if operation == "score":
            ...
            prompt_parts.append("")
            prompt_parts.append("Respond with JSON only. Begin your response with {")
...
def create_memory_cortex(
    ...
    Args:
        base_model: Base model identifier for the memory neuron
    ...
    neuron = MemoryCortex(base_model=base_model)
